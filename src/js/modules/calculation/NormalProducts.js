...
export class NormalProducts {
  constructor() {
    ...
    document
      ...
      .addEventListener('change', this.getProductPrice.bind(this))
    document
      .getElementById(crease)
      .addEventListener('change', this.getProductPrice.bind(this))
    document
      .getElementById(corners)
  ...
  getProductPrice() {
    ...
    const creaseProd = getService(
      this.variables.crease,
      this.theFormProduct,
      priceList.productCrease
    )
    const sheetsProd = getService(
      this.variables.sheets,
      this.theFormProduct,
      priceList.productSheets
    )
    const cornersProd = getCorners(
      this.variables.corners,
      this.theFormProduct,
      priceList.corners
    )
    const printProd = this.printStandard.getPricePrint(
      count,
      sizeProd,
      priceList
    )
    ...
    const sumOfvalues =
      (sizeProd * materialProd * sheetsProd + creaseProd + cornersProd) *
        count +
      printProd +
      foilProd
    //----------------------------------------------------------------//
